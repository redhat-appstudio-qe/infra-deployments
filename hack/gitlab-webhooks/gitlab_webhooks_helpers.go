...
// getExternalGitLabRepositories retrieves all repositories with a git provider URL of 'https://gitlab.com'.
func getExternalGitLabRepositories() ([]Repository, error) {
