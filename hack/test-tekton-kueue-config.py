...
TEST_COMBINATIONS: Dict[str, TestCombination] = {
    ...
    # KFLUXINFRA-3980 ring 3: build-platforms type guard folded into base
    # (and kflux-rhel-p01's permanent override). Ring 1's stone-prod-p01 /
    # kflux-prd-rh02 and ring 2's kflux-osp-p01 / kflux-prd-rh03 temporary
    # overrides are removed; those clusters now inherit this base coverage.
