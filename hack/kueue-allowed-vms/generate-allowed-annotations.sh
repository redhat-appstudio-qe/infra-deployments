...
main() {
  ...
  local -A queue_configs=(
      ["components/kueue/rings/ring-1/stone-stage-p01"]="components/policies/staging/stone-stage-p01/kueue/deny-unallowed-annotations/"
      ["components/kueue/rings/ring-1/stone-stg-rh01"]="components/policies/staging/stone-stg-rh01/kueue/deny-unallowed-annotations/"
  )
